...
real prec_inst(nx,ny) ! CMuller add Instantaneous surface precipitation flux (mm/day)
...
real u5km_xy(nx,ny) ! u at 5km
real v5km_xy(nx,ny) ! v at 5km
real w5km_xy(nx,ny) ! w at 5km
real qv5km_xy(nx,ny) ! qv at 5km
real qn5km_xy(nx,ny) ! qn at 5km
real qp5km_xy(nx,ny) ! qp at 5km
real ta5km_xy(nx,ny) ! ta at 5km
real qocean_xy(nx,ny) ! ocean cooling in W/m2
real qn_xy(nx,ny)   ! CMuller: Non precipitating condensate amount
real qp_xy(nx,ny)   ! CMuller: Precipitating condensate amount
real mse_xy(nx,ny)   ! CMuller: MSE
