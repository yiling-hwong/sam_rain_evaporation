...
def plot_timeseries(thetav_wet_timeseries_cda,thetav_dry_timeseries_cda,theta_wet_timeseries_cda,theta_dry_timeseries_cda, qv_wet_timeseries_cda,qv_dry_timeseries_cda,
                             thetav_wet_timeseries_rda, thetav_dry_timeseries_rda,theta_wet_timeseries_rda, theta_dry_timeseries_rda,
                             qv_wet_timeseries_rda, qv_dry_timeseries_rda):
    ...
    ylim_min_cda = -2e-3
    ylim_max_cda = -ylim_min_cda
    ylim_min_rda = -2e-3 #-5e04
    ylim_max_rda = -ylim_min_rda

    # --------- GET TIME AXIS AND ZERO ARRAY
    times = [int(n) for n in range(len(thetav_wet_timeseries_cda[0]))]
    ...
    for col, big_ax in enumerate(big_axes, start=0):
        ...
        if col == 0:
            big_ax.set_title("CDA", fontsize=title_fontsize+1, weight="bold",pad=bigframe_pad)
        if col == 1:
            big_ax.set_title("RDA", fontsize=title_fontsize+1, weight="bold", pad=bigframe_pad)
    ...
    ax1.plot(times, thetav_wet_timeseries_cda[0], color="red", linestyle="solid", label="Moist")
    ax1.plot(times, thetav_wet_timeseries_cda[1], color="red", linestyle="dashed")
    ax1.plot(times, thetav_dry_timeseries_cda[0], color="blue", linestyle="solid", label="Dry")
    ax1.plot(times, thetav_dry_timeseries_cda[1], color="blue", linestyle="dashed")

    ax1.set_xlim(xlim_min, xlim_max)
    ax1.set_ylim(ylim_min_cda, ylim_max_cda)
    ...
    labels_leg2 = ["L128_HomoRad", "L256_HomoRad"]
    ...
    ax2.plot(times, thetav_wet_timeseries_rda[0], color="red", linestyle="dotted", linewidth=2.0, label="Moist")
    ax2.plot(times, thetav_dry_timeseries_rda[0], color="blue", linestyle="dotted", linewidth=2.0, label="Dry")

    ax2.set_xlim(xlim_min, xlim_max)
    ax2.set_ylim(ylim_min_rda, ylim_max_rda)
    ...
    custom_lines = [Line2D([0], [0], color="black", lw=1.5, linestyle="dotted")]

    labels_leg2 = ["L256_IntRad"]
    ...
    ax3.plot(times, theta_wet_timeseries_cda[0], color="red", linestyle="solid", label="Moist")
    ax3.plot(times, theta_wet_timeseries_cda[1], color="red", linestyle="dashed")
    ax3.plot(times, theta_dry_timeseries_cda[0], color="blue", linestyle="solid", label="Dry")
    ax3.plot(times, theta_dry_timeseries_cda[1], color="blue", linestyle="dashed")

    ax3.set_xlim(xlim_min, xlim_max)
    ax3.set_ylim(ylim_min_cda, ylim_max_cda)
    ...
    ax4.plot(times, theta_wet_timeseries_rda[0], color="red", linestyle="dotted", linewidth=2.0, label="Moist")
    ax4.plot(times, theta_dry_timeseries_rda[0], color="blue", linestyle="dotted", linewidth=2.0, label="Dry")

    ax4.set_xlim(xlim_min, xlim_max)
    ax4.set_ylim(ylim_min_rda, ylim_max_rda)
    ...
    ax5.plot(times, qv_wet_timeseries_cda[0], color="red", linestyle="solid", label="Moist")
    ax5.plot(times, qv_wet_timeseries_cda[1], color="red", linestyle="dashed")
    ax5.plot(times, qv_dry_timeseries_cda[0], color="blue", linestyle="solid", label="Dry")
    ax5.plot(times, qv_dry_timeseries_cda[1], color="blue", linestyle="dashed")

    ax5.set_xlim(xlim_min, xlim_max)
    ax5.set_ylim(ylim_min_cda, ylim_max_cda)
    ...
    ax6.plot(times, qv_wet_timeseries_rda[0], color="red", linestyle="dotted", linewidth=2.0, label="Moist")
    ax6.plot(times, qv_dry_timeseries_rda[0], color="blue", linestyle="dotted", linewidth=2.0, label="Dry")

    ax6.set_xlim(xlim_min, xlim_max)
    ax6.set_ylim(ylim_min_rda, ylim_max_rda)
...
def main():
    ...
    configs_cda = ["0_L256", "0_L128"] # CDA
    configs_rda = ["1_intrad_L256"]  # RDA

    thetav_wet_timeseries_cda = get_timeseries(configs_cda,"thetav_wet")
    thetav_dry_timeseries_cda = get_timeseries(configs_cda,"thetav_dry")
    theta_wet_timeseries_cda = get_timeseries(configs_cda,"theta_wet")
    theta_dry_timeseries_cda = get_timeseries(configs_cda,"theta_dry")
    qv_wet_timeseries_cda = get_timeseries(configs_cda,"qv_wet")
    qv_dry_timeseries_cda = get_timeseries(configs_cda,"qv_dry")

    thetav_wet_timeseries_rda = get_timeseries(configs_rda,"thetav_wet")
    thetav_dry_timeseries_rda = get_timeseries(configs_rda,"thetav_dry")
    theta_wet_timeseries_rda = get_timeseries(configs_rda,"theta_wet")
    theta_dry_timeseries_rda = get_timeseries(configs_rda,"theta_dry")
    qv_wet_timeseries_rda = get_timeseries(configs_rda,"qv_wet")
    qv_dry_timeseries_rda = get_timeseries(configs_rda,"qv_dry")


    plot_timeseries(thetav_wet_timeseries_cda,thetav_dry_timeseries_cda,theta_wet_timeseries_cda,theta_dry_timeseries_cda, qv_wet_timeseries_cda,qv_dry_timeseries_cda,
                             thetav_wet_timeseries_rda, thetav_dry_timeseries_rda,theta_wet_timeseries_rda, theta_dry_timeseries_rda,
                             qv_wet_timeseries_rda, qv_dry_timeseries_rda)
