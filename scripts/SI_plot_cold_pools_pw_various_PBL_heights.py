...
def plot_figure(coldpools_all,pw_all,plot_labels):
    ...
    for row in range(4):
        for col in range(2):
            ...
            # 1 and 2km
            if row == 0 and col == 0:
                big_axes[row,col].set_title(r"$h_\mathrm{evp}$ = 1 km", fontsize=title_fontsize, pad=bigframe_pad)
            if row == 0 and col == 1:
                big_axes[row, col].set_title(r"$h_\mathrm{evp}$ = 2 km", fontsize=title_fontsize, pad=bigframe_pad)
            if row == 1 and col == 0:
                big_axes[row,col].set_title(r"$h_\mathrm{evp}$ = 1 km", fontsize=title_fontsize, pad=bigframe_pad)
            if row == 1 and col == 1:
                big_axes[row, col].set_title(r"$h_\mathrm{evp}$ = 2 km", fontsize=title_fontsize, pad=bigframe_pad)
            ...
            # 3 and 4km
            if row == 2 and col == 0:
                big_axes[row,col].set_title(r"$h_\mathrm{evp}$ = 3 km", fontsize=title_fontsize, pad=bigframe_pad)
            if row == 2 and col == 1:
                big_axes[row, col].set_title(r"$h_\mathrm{evp}$ = 4 km", fontsize=title_fontsize, pad=bigframe_pad)
            if row == 3 and col == 0:
                big_axes[row,col].set_title(r"$h_\mathrm{evp}$ = 3 km", fontsize=title_fontsize, pad=bigframe_pad)
            if row == 3 and col == 1:
                big_axes[row, col].set_title(r"$h_\mathrm{evp}$ = 4 km", fontsize=title_fontsize, pad=bigframe_pad)
...
def main():
    ...
    configs = ["alpha0.005_L128","alpha0.01_L128","alpha0.05_L128_2km","alpha0.06_L128_2km",
               "alpha0.06_L128_3km","alpha0.07_L128_3km","alpha0.07_L128_4km","alpha0.08_L128_4km",]
    plot_labels = [r"(a) ${\alpha}$=0.005",r"(b) ${\alpha}$=0.01",r"(c) ${\alpha}$=0.05",r"(d) ${\alpha}$=0.06",
                   r"(e) ${\alpha}$=0.005",r"(f) ${\alpha}$=0.01",r"(g) ${\alpha}$=0.05",r"(h) ${\alpha}$=0.06",
                   r"(i) ${\alpha}$=0.06", r"(j) ${\alpha}$=0.07", r"(k) ${\alpha}$=0.07", r"(l) ${\alpha}$=0.08",
                   r"(m) ${\alpha}$=0.06", r"(n) ${\alpha}$=0.07", r"(o) ${\alpha}$=0.07", r"(p) ${\alpha}$=0.08"
                   ]
